...
Route::group(['middleware' => ['XssSanitizer']], function ()
{
    ...
    Route::any('/especialistas',[WebsiteController::class,'doctor']);
    ...
    Route::any('/se-parte',[WebsiteController::class,'seParte']);
    ...
    Route::any('/inicia-sesion',[WebsiteController::class,'patientLogin']);
