...
<section class="section">
    ...
    <form action="{{ url('update_doctor_profile') }}" method="post" enctype="multipart/form-data" class="myform">
        ...
        <div class="card">
            ...
            <div class="text-center alert-success mx-4 py-1" style="font-weight:bold;color:#0abf3a;">Please fill up the following details to enhance the patient's experience.</div>
            <div class="card-body">
                <div class="row mt-4">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6 form-group">
                        <label class="col-form-label">{{__('Cedula')}}</label>
                        <input type="text" class="form-control @error('cedula') is-invalid @enderror" value="{{$doctor->cedula}}" name="cedula" >
                        @error('cedula')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 form-group">
                        <label class="col-form-label">{{__('Especialidad')}}</label>
                        <input type="text" class="form-control @error('espc') is-invalid @enderror" value="{{$doctor->especiality}}" name="especiality" >
                        @error('espc')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
