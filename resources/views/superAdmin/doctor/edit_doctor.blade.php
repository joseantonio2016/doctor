            ...
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" class="form-control @error('ced') is-invalid @enderror" value="{{old('ced')}}" name="ced" >
                        @error('ced')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" class="form-control @error('espc') is-invalid @enderror" value="{{old('espc')}}" name="espc" >
                        @error('espc')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
