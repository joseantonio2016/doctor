@extends('layout.mainlayout_admin-k',['activePage' => 'home'])

@section('title',__('Especialista'))
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-lg-7">
            <div class="card card-chart">
                <div class="card-header">{{__("Cita de hoy")}}
                </div>
                <div class="card-body">
